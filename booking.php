...
if(isset($_POST['submit']))
{
	...
	$booking_time= mysqli_real_escape_string($_POST['booking_time']);
	$booking_date= mysqli_real_escape_string($_POST['booking_date']);
	$booking_name= mysqli_real_escape_string($_POST['booking_name']);
	$booking_mobile= mysqli_real_escape_string($_POST['booking_mobile']);
	$booking_passengernum= mysqli_real_escape_string($_POST['booking_passengernum']);
	$booking_pickuptime= mysqli_real_escape_string($_POST['booking_pickuptime']);
	$booking_pickupdate= mysqli_real_escape_string($_POST['booking_pickupdate']);
	$booking_pickupaddress= mysqli_real_escape_string($_POST['booking_pickupaddress']);
	$booking_dropoffaddress= mysqli_real_escape_string($_POST['booking_dropoffaddress']);
	$booking_ride_id= mysqli_real_escape_string($_POST['booking_ride_id']);
	$booking_numofcars= mysqli_real_escape_string($_POST['booking_numofcars']);
	...
	echo "<script type='text/javascript'>alert('Your booking is successfully submitted. Now please wait for our agent to call back to confirm the booking. Thankyou!')</script>";
		...
		echo "<script type='text/javascript'>alert('!!NOT Submitted  Successfully.! ! ! ERROR!!Please subit again. Thankyou.')</script>";
	}
 ...
 <!-- ,,,,,,,,booking_dropoffaddress,booking_ride_id,booking_numofcars -->
	<!-- Form Item Input -->
		<!-- Form Item Input -->
			<div class="row m-1">
					...
					<div class="border border-dark m-1 p-4">
						...
						<form method="POST" enctype="multipart/form-data">
							<div class="form-row">
							    ...
							    <input type="hidden" name="booking_date" class="form-control" id="validationCustom01" placeholder="Name"  required>

							</div>
							<div class="form-row">
								<label><h6>Time: <?php echo $time; ?></h6></label>
							    <input type="hidden" name="booking_time" class="form-control" id="validationCustom01" placeholder="Name"  required>
							  ...
							  <div class="form-row">
							    <div class="col-md-6 mb-3">
							      ...
							      <input type="textbox" name="booking_pickupaddress" class="form-control" id="validationCustom01" placeholder="Pickup Address" required>
							      <div class="valid-feedback">
							        Looks good!
							      </div>
							    </div>
							    <div class="col-md-6 mb-3">
							      ...
							      <input type="text" name="booking_dropoffaddress" class="form-control" id="validationCustom01" placeholder="First name" required>
							      <div class="valid-feedback">
							        Looks good!
							      </div>
							    </div>
                                          ...
                                          ">
						                        <div class="row " >
						                          <div class="col-md-4 align-middle">
						                            <img src="<?php echo $row['ride_image']; ?>" class="img-thumbnail" alt="" style="height: 100px !important; ">
						                          </div>
